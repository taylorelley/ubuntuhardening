...
# ~/CIS-LBK/functions/recommendations/nix_cramfs_filesystem_disabled_rec.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       05/06/20    Recommendation "Ensure mounting of cramfs filesystems is disabled"
# Eric Pinnell       04/19/22    Modified corrected false positive and enhanced logging
# 
cramfs_filesystem_disabled_rec()
{
