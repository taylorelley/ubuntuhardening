...
# ~/CIS-LBK/functions/recommendations/nix_freevxfs_filesystem_disabled.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/17/20    Recommendation "Ensure mounting of freevxfs filesystems is disabled"
# Eric Pinnell       04/19/22    Modified corrected false positive and enhanced logging
# 
freevxfs_filesystem_disabled()
{
