...
# ~/CIS-LBK/functions/recommendations/nix_squashfs_filesystem_disabled.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       05/06/20    Recommendation "Ensure mounting of squashfs filesystems is disabled"
# Eric Pinnell       04/19/22    Modified corrected false positive and enhanced logging
# 
squashfs_filesystem_disabled()
{
